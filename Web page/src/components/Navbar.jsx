    ...
    >
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {/* Dropdown */}
                  <div
                    className={`absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-xl shadow-slate-200/60
                      border border-slate-100 overflow-hidden transition-all duration-200 origin-top-right z-50
                      ${showProfile
      ...
      <div
        className={`md:hidden absolute left-0 right-0 bg-white border-b border-slate-200 shadow-lg transition-all duration-300 ease-out overflow-hidden
          ${mobileMenuOpen ? "opacity-100 translate-y-0 max-h-[500px] visible" : "opacity-0 -translate-y-2 max-h-0 invisible pointer-events-none"}`}
      >
