...
const tabs = [
  ...
  },
  {
    ...
    icon: FiEye,
    content:
      "A world where distance and time zones are no barriers to seamless, productive teamwork.",
  },
  {
    id: "values",
    label: "Values",
    icon: FiHeart,
    content:
      "Customer obsession, innovation, inclusivity, and relentless pursuit of excellence in everything we build.",
  },
];
